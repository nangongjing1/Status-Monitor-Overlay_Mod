...
public:
    ...
    virtual tsl::elm::Element* createUI() override {
        ...
        auto* Status = new tsl::elm::CustomDrawer([this](tsl::gfx::Renderer *renderer, u16 x, u16 y, u16 w, u16 h) {
            ...
            // Temperature
            renderer->drawString("电池温度", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
            ...
            // Voltage
            renderer->drawString("输入电压", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
            renderer->drawString(voltageAvg_c, false, VALUE_X, currentY, FONT_SIZE, VALUE_COLOR);
            currentY += LINE_HEIGHT;
            
            // Current Flow
            renderer->drawString("输入电流", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
            renderer->drawString(currentFlow_c, false, VALUE_X, currentY, FONT_SIZE, VALUE_COLOR);
            currentY += LINE_HEIGHT;
            
            // Power Flow
            renderer->drawString("输入功率", false, LABEL_X, currentY, FONT_SIZE, LABEL_COLOR_2);
            ...
            if (isChargerConnected) {
                ...
                renderer->drawString("充电状态", false, LABEL_X, currentY, 20, LABEL_COLOR_1);
